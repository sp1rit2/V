...
class Sorting extends Component{
    ...
    async navigate(){
        ...
        console.log("navigate : "+this.state.flag)
        ...
        {
            await bs.bubbleS(this.state.array,120)
        }
        else if(this.state.flag==2)
        {
            await ins.insertionSort(this.state.array,120)
        }
        else if(this.state.flag==3)
        {
            await sel.selectionSort(this.state.array,120)
        }
        else if(this.state.flag==4)
        {
            await hp.heapSort(this.state.array,120)
        }
        ...
        {
            await qs.quickSort(this.state.array,120)
        }
